test( "Check that time is returned as a stopwatch string with always double digits e.g. input->9 output->09", function() {
  equal( T.humanTime(0), '00' );
  equal( T.humanTime(1), '01' );
  equal( T.humanTime(10), '10' );
});
